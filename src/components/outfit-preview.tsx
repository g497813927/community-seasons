...
export function OutfitPreview({ skin, outfit, label, className, facing = "back" }: {
  skin: SkinId; outfit: Outfit; label?: string; className?: string; facing?: "back" | "front";
}) {
  return (
    <svg className={className} viewBox="0 0 160 160" role={label ? "img" : undefined}
      ...
      {getSkinPreview(skin, outfit, facing).map((face, index) => (
