...
Examples:
  ...
  python3 fuzz_game.py quick --suite engine-properties --runs 20 --seed 123
  python3 fuzz_game.py quick --forever --duration 60 --seed 123
  FC_PROPERTY=numeric-dt FC_SEED=123 python3 fuzz_game.py quick --suite engine-properties
