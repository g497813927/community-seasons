...
try {
  for (const config of cases) {
    ...
    try {
      ...
      await page.screenshot({ path: `qa/archive/boost-controls-qa/${width}-${locale}-${scale}-opening.png` });
      ...
      await page.screenshot({ path: `qa/archive/boost-controls-qa/${width}-${locale}-${scale}-running.png` });
      ...
      await page.screenshot({ path: `qa/archive/boost-controls-qa/${width}-${locale}-${scale}-active.png` });
      ...
      await page.screenshot({ path: `qa/archive/boost-controls-qa/${width}-${locale}-${scale}-failure.png` }).catch(() => {});
    }
    rows.push(row);
  ...
  fs.writeFileSync('qa/archive/boost-controls-qa/results.json', JSON.stringify({
