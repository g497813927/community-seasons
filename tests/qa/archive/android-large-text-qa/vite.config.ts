...
{find:'@/lib/game/engine',replacement:local('./engine.ts')},{find:'@/lib/game/toy-sdk',replacement:local('./toy-sdk.ts')},{find:'@',replacement:local('../../../../src/')}
]},css:{postcss:{plugins:[tailwindcss({base:local('../../../../src/')})]}},server:{host:'127.0.0.1',port:3028,strictPort:true,fs:{allow:[local('../../../../')]}}});
