...
const { SCENES, isSceneKind, nextScene } = await import('../helpers/compiled/scenes.mjs');
const { BOOSTERS } = await import('../helpers/compiled/boosts.mjs');
const { getLesson, LESSONS, localized } = await import('../helpers/compiled/community.mjs');
