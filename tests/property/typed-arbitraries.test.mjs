      ...
      JSON.stringify(
        {
          ...
          counterexample: null,
          replay: `FC_TYPED_SEED=${baseSeed}${replayPath ? ` FC_TYPED_PATH='${quotedPath}'` : ""} node --test --test-name-pattern='${name}' tests/property/typed-arbitraries.test.mjs`,
        },
        null,
        2,
      ),
      ...
      JSON.stringify(
        {
          ...
          replay: `FC_TYPED_SEED=${result.seed - index} FC_TYPED_PATH='${result.counterexamplePath}' node --test --test-name-pattern='${name}' tests/property/typed-arbitraries.test.mjs`,
        },
        null,
        2,
      ),
