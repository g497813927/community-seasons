...
- **Releases:** follow the [release guide](docs/RELEASE.md). Deployment and GitHub pushes require authorization. Content-only updates must preserve existing publication settings, and credentials must never be committed.
