...
const suiteScripts = {
  engine: 'work/community-tests/engine-state-fuzz.test.mjs',
  economy: 'work/community-tests/store-economy-fuzz.test.mjs',
  'engine-properties': 'work/property-tests/engine-invalid.test.mjs',
  'save-properties': 'work/property-tests/save-invalid.test.mjs',
  'typed-generators': 'work/property-tests/typed-arbitraries.test.mjs',
  renderer: 'work/renderer-fuzz.mjs',
};
const engineRegressions = [
  'work/community-tests/rail-approach-warmup.test.mjs',
  'work/community-tests/railway-forks.test.mjs',
  'work/community-tests/boost-fork-assist.test.mjs',
  'work/community-tests/cottage-roof-visibility.test.mjs',
  'work/community-tests/summer-boardwalk-supports.test.mjs',
  'work/community-tests/boost-barrier-protection.test.mjs',
];
const replayKeys = [
